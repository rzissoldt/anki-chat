...
function ToolFallbackResult({
  ...
  return (
    ...
    >
      ...
      <pre className="aui-tool-fallback-result-content bg-muted/50 text-foreground/90 mt-1 max-h-48 overflow-auto rounded-md p-2.5 text-xs break-all whitespace-pre-wrap">
